    ...
    <div class="boletins-shell" [class.authenticated]="isAuthenticated">
      ...
      <aside class="boletins-sidebar glass" *ngIf="isAuthenticated">
        ...
        <nav class="sidebar-nav">
          <a routerLink="/boletins" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}" class="nav-item">
            <span class="nav-icon">📋</span>
            <span class="nav-label">Lista de Boletins</span>
          </a>
          <a routerLink="/boletins/admin/novo" routerLinkActive="active" *ngIf="isAdmin" class="nav-item">
            <span class="nav-icon">➕</span>
        ...
        <div class="sidebar-footer">
          <div class="user-profile">
            ...
            <div class="user-info">
              ...
              <span class="user-role">{{ isAdmin ? 'Administrador' : 'Membro' }}</span>
            </div>
          </div>
